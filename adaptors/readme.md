# IBM Digital Business Automation - Process Automation Manager Open Edition - Adaptors

This repository contains various product extensions, adaptors, and application programming interfaces (API's) to be used in conjunction with `IBM Process Automation Manager Open Edition` projects.
...
1.  [**KIE Server Adaptor**](./kie-server-adaptor.readme.md) - A sample adaptor to the KIE Server's REST API, used to augment the REST API and other internval behavior of the KIE Server.
